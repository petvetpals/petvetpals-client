    ...
    return (
        <div className="relative w-full" ref={containerRef}>
            <div
                ...
                className="capitalize cursor-pointer text-gray-800 font-light border border-gray-300 p-2 rounded outline-[#5d3855a3] flex justify-between items-center bg-white text-sm"
            >
